    ...
    <section id="products" className="py-24 bg-muted/30">
      <div className="container">
        <div className="text-center max-w-2xl mx-auto mb-12">
          ...
          <h2 className="font-display text-4xl font-bold text-foreground mb-4">Industrial Packaging Solutions</h2>
          <p className="text-muted-foreground">Complete range of stretch films, poly bags, BOPP bags, tarpaulin, and packaging accessories. Custom sizes and printing available.</p>
        </div>
